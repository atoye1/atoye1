...
당연한 명제에 대해서도 "왜?" 라는 질문을 던지기 좋아합니다. 한국의 문화적 맥락에서 눈총을 받을 때도 있지만, 질문을 통해 팀원 모두 문제의 본질을 파악하고 좋은 성과를 낼 수 있는 기회를 놓치지 않는 용기를 가지고 있습니다.

## 개발에 대한 관심과 열정

안정적인 직장에 재직중이었음에도 방송대 컴퓨터과학과를 우수한 성적으로 졸업하고, 코드스테이츠 부트캠프를 수료한 것은 스스로의 개발에 대한 관심과 열정이 없었으면 불가능했을 것입니다. 오랜기간 커리어 전환을 위해 착실히 준비해왔다는 사실은 제 끈기와 개발에 대한 열정이 앞으로도 변함없을 것이라는 증명해 줍니다.
...
홈 오피스, 2019.06 - 2020.01

- 직접 개발한 웹크롤러와 상품등록 자동화 시스템  활용(selenium, pyautogui, openpyxl 활용)
- 상품 자동 등록 및 자동 주문 시스템 일부 구현
- 저작권 관련 법률 리스크로 폐업
...
2022.09 - 2023.02 7기 수료

## 부산 블록체인 지역특화 프로젝트 과정

한국표준협회 | 2022.08.01 - 2022.08.29
